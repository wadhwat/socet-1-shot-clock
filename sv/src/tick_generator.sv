module tick_generator #(
    ...
    parameter integer TICK_2640_HZ = 2640,
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (conditioned_2640_counter >= CONDITIONED_2640_MAX - 1) begin
                conditioned_2640_counter <= 0;
                tick_2640Hz <= 1;
            end else begin
                conditioned_2640_counter <= conditioned_2640_counter + 1;
                tick_2640Hz <= 0;
            end
        end
    end
